...
const Cex = ({
    ...
    const imgWrapperClassName = "bg-white h-full rounded-lg p-2 flex-1 w-40 md:w-60 flex items-center justify-center";
    ...
    const renderArray = (array: string[], left = false) => (
        <div className="relative flex-1">
            <div className={`h-full absolute bg-repeat animate-scroll-infinite inline-flex gap-3.5 flex-nowrap ${left ? 'left-0 animate-scroll-infinite-left' : 'right-0 animate-scroll-infinite-right'}`}>
    ...
    return (
        <div className="flex flex-col h-48 md:h-64 gap-5 relative py-4 md:py-8 px-5 rounded-xl overflow-hidden">
            <div
